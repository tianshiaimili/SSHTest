...
<body>
	<div class="navbar navbar-fixed-top" align="center">
		...
		<%=request.getContextPath()%>
			<form class="well" action="<%=request.getContextPath()%>/search" method="post">
				<input type="text" class="span3" name="user.name"
					placeholder="Type name ...">
				<button type="submit" class="btn">search</button>
			</form>
		</span> <span>
		<!-- onclick="window.location.href='/jsp/addpage.jsp'" -->
			<button class="btn" onclick="window.location.href='<%=request.getContextPath()%>/jsp/addpage.jsp'">add
				a user</button>
		</span> <br>
		<div align="center">
